...
let UsersService = class UsersService {
    ...
    async findTeachers() {
        return this.usersRepo.find({ where: { role: user_entity_1.UserRole.TEACHER, isActive: true } });
    }
    async findAdmins() {
        return this.usersRepo.find({ where: { role: user_entity_1.UserRole.ADMIN, isActive: true } });
    }
    ...
    async createOrUpdateOAuthUser(oauthData) {
        ...
        if (oauthData.microsoftId)
            user.microsoftId = oauthData.microsoftId;
        if (oauthData.avatar)
