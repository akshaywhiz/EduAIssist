...
__decorate([
    (0, typeorm_1.OneToMany)(() => exam_entity_1.Exam, (exam) => exam.createdBy),
    __metadata("design:type", Array)
], User.prototype, "createdExams", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => evaluation_entity_1.Evaluation, (evaluation) => evaluation.evaluatedBy),
    __metadata("design:type", Array)
