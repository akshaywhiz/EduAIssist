  ...
  return (
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Study Material/Book</label>
      ...
      <div className="mb-6">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          <div className="flex justify-between items-center">
            <span className="text-sm font-medium text-gray-700">Total Weightage: {mcqWeightage + shortWeightage + longWeightage}%</span>
            <span className="text-sm font-medium text-gray-700">Calculated Marks: {totalCalculatedMarks}/{maxMarks}</span>
          </div>
